...
try:
    ...
    raise NotImplementedError("TkPandalone is only supported on Python-3; not in Python-%s!" % sys.version_info[0])
...
class TkPandalone:
    ...
    def _do_about(self):
        ...
        with pkg.resource_stream('pandalone', '../docs/about.png') as fd: #@UndefinedVariable
            img = Image.open(fd)
